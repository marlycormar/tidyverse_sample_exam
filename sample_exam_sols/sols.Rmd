...
1. There are four errors in the RMarkdown file:
    ...
    1. Line 3: Add missing `:` to `output`, i.e., line 3 should read `output:`. Also, hit tab on line 4 since yaml relies on identation.
...
- A rating, which is one of “negative”, “positive”, “indi!erent”, or “wtf” (meaning the respondent didn’t understand the question).
